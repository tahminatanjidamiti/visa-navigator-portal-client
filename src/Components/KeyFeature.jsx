...
const KeyFeature = () => {
    return (
        <div className='my-20'>
            ...
            <p className='my-5 w-9/12 mx-auto text-center'>Unlock the key to effortless visa applications with our expert insights, up-to-the-minute updates, and tailored assistance, ensuring your international travel is smooth and stress-free.</p>
            <div>
                <div className="card bg-teal-400 text-neutral-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-11/12 mx-auto">
